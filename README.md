.. -*- mode: rst -*-
==========================================
 Keyboards for the Tuvinian language
==========================================

This directory contains source files and build instructions for developing
keyboards for the Tuvinian language. The data and implementations
...
* http://giellatekno.uit.no/tyvdoc/index.html
* https://giellalt.uit.no/tools/docu-tyv-manual.html
...
The Tuvinian keyboard sources can be acquired using the `Giella SVN
